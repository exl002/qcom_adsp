...
rem --------------------------------------------------------------------------
rem
rem $Header: //components/rel/dspbuild.adsp/2.2/ms/build_8094.cmd#5 $
...
SET BUILD_ASIC=8094
SET MSM_ID=8094
SET HAL_PLATFORM=8094
SET TARGET_FAMILY=8094
SET CHIPSET=mpq8094
if "%BUILD_FLAGS%"=="" (
