...
rem --------------------------------------------------------------------------
rem
rem $Header: //components/rel/dspbuild.adsp/2.2/ms/build_8092.cmd#5 $
...
SET BUILD_ASIC=8092
SET MSM_ID=8092
SET HAL_PLATFORM=8092
SET TARGET_FAMILY=8092
SET CHIPSET=mpq8092
if "%BUILD_FLAGS%"=="" (
