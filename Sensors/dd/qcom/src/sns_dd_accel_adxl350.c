...
/*==============================================================================
  ...
  $Header: //components/rel/ssc.adsp/2.4.1/adsp_proc/Sensors/dd/qcom/src/sns_dd_accel_adxl350.c#1 $
...
static sns_ddf_status_e sns_dd_adxl350_get_data(
...
*/
/*=========================================================================*/
static sns_ddf_status_e adxl350_log_data(sns_ddf_sensor_data_s *data_ptr)
{
