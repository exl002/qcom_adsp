...
#define SNS_SAM_USEC_PER_SEC 1000000.0f
...
#define SNS_SAM_SLOW_BATCH_DURATION_US (1000000)
/*---------------------------------------------------------------------------
* Type Declarations
* -------------------------------------------------------------------------*/
/*=======================================================================*/
...
typedef struct {
   ...
   uint32_t sensorReportRate;        /* the sensor report rate in use by the algo
                                     instance in Q16 Hz*/
} sns_sam_algo_inst_s;
