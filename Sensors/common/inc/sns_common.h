...
#define SNS_MODULE_DSPS_SSM       (SNS_MODULE_DSPS + 06)    /* Sensors Service Manager */
#ifdef SNS_QMI_ENABLE
#define SNS_MODULE_DSPS_DEBUG     (SNS_MODULE_DSPS + 07)    /* Diag/debug */
#endif
...
#define SNS_SSM_QUE_MUTEX        (SNS_DSPS_MUTEX_PRI_BASE  + 06)
...
#define SNS_MODULE_PRI_DSPS_SSM   (SNS_DSPS_MODULE_PRI_BASE + 8)
#else //QDSP6
#ifdef SNS_QDSP_SIM
#define SNS_MODULE_STK_SIZE_DSPS_EVMGR    (0x300)
#define SNS_MODULE_PRI_DSPS_SSM   (SNS_DSPS_MODULE_PRI_BASE + 8)
#define SNS_MODULE_PRI_DSPS_EVMGR (SNS_DSPS_MODULE_PRI_BASE + 07)
#define SNS_MODULE_PRI_DSPS_SAM   (SNS_DSPS_MODULE_PRI_BASE + 06)
#define SNS_MODULE_PRI_DSPS_SMGR  (SNS_DSPS_MODULE_PRI_BASE + 05)
...
#define SNS_MODULE_STK_SIZE_DSPS_SAM    (0x600)
#define SNS_MODULE_STK_SIZE_DSPS_SMR    (0x300)
#define SNS_MODULE_STK_SIZE_DSPS_SCM    (0x600)
#define SNS_MODULE_STK_SIZE_DSPS_SSM    (0x100)
#ifdef SNS_QMI_ENABLE
...
sns_rtb_s sns_rtb[] = {
    ...
    { SNS_SAM_FNS_SVC_ID_V01,             SNS_MODULE_DSPS_SAM,  SNS_GET_SVC_OBJ(SAM_FNS, 01),                 NULL }, /* 9 */
    { SNS_SAM_BTE_SVC_ID_V01,             SNS_MODULE_DSPS_SAM,  SNS_GET_SVC_OBJ(SAM_BTE, 01),                 NULL }, /* 10 */
    ...
    { SNS_SAM_FILTERED_MAG_SVC_ID_V01,    SNS_MODULE_DSPS_SAM,  SNS_GET_SVC_OBJ(SAM_FILTERED_MAG, 01),    NULL }, /* 17 */
    { SNS_SAM_ROTATION_VECTOR_SVC_ID_V01, SNS_MODULE_DSPS_SAM,  SNS_GET_SVC_OBJ(SAM_ROTATION_VECTOR, 01), NULL }, /* 18 */
    { SNS_SAM_QUATERNION_SVC_ID_V01,      SNS_MODULE_DSPS_SAM,  SNS_GET_SVC_OBJ(SAM_QUATERNION, 01),          NULL }, /* 19 */
    { SNS_SAM_GRAVITY_VECTOR_SVC_ID_V01,  SNS_MODULE_DSPS_SAM,  SNS_GET_SVC_OBJ(SAM_GRAVITY_VECTOR, 01),      NULL }, /* 20 */
    ...
    { SNS_SAM_ORIENTATION_SVC_ID_V01,     SNS_MODULE_DSPS_SAM,  SNS_GET_SVC_OBJ(SAM_ORIENTATION, 01),     NULL }, /* 23 */
    { SNS_TIME2_SVC_ID_V01,               SNS_MODULE_APPS_TIME, SNS_GET_SVC_OBJ(TIME2, 02),                   NULL }, /* 24 */
    { SNS_SAM_BASIC_GESTURES_SVC_ID_V01,  SNS_MODULE_DSPS_SAM,  SNS_GET_SVC_OBJ(SAM_BASIC_GESTURES, 01),      NULL }, /* 25 */
    { SNS_SAM_TAP_SVC_ID_V01,             SNS_MODULE_APPS_SAM,  SAM_ON_APPS_SVC_OBJ(SAM_TAP, 01),             NULL }, /* 26 */
    { SNS_SAM_FACING_SVC_ID_V01,          SNS_MODULE_DSPS_SAM,  SNS_GET_SVC_OBJ(SAM_FACING, 01),              NULL }, /* 27 */
    ...
    { SNS_SAM_MODEM_SCN_SVC_ID_V01,       SNS_MODULE_DSPS_SAM,  SNS_GET_SVC_OBJ(SAM_MODEM_SCN, 01),           NULL }, /* 39 */
    ...
    { SNS_SAM_GAME_ROTATION_VECTOR_SVC_ID_V01, SNS_MODULE_DSPS_SAM, SNS_GET_SVC_OBJ(SAM_GAME_ROTATION_VECTOR,01), NULL }, /* 43 */
