...
$Header: //components/rel/ssc.adsp/2.4.1/adsp_proc/Sensors/common/core/src/8960/sns_freerun_timer.c#1 $


when         who     what, where, why
----------   ---     ---------------------------------------------------------
2011-04-17   jh      Initial version for 8960
...
void sns_freerun_timer_enable ( uint32_t timer_id )
{
  ...
  HWIO_OUTI(XO_TMRn_CONTROL, timer_id, HWIO_FMSK(XO_TMRn_CONTROL, EN));
}
...
{
  HWIO_OUTI(XO_TMRn_CLEAR_CNT, timer_id, 1);
