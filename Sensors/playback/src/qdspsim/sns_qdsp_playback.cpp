...
void sns_playback_simulate_algo(pb_algo_attrib_s *algo_attr)
{
    ...
    switch(algo_attr->svc_id)
    {
        ...
        case SNS_SAM_GAME_ROTATION_VECTOR_SVC_ID_V01:
            printf("PLAYBACK: GAME_ROTATION_VECTOR Simulation requested\n");
            err = sns_plbk_sam_game_rotation_vector_enable(algo_attr->algo_config, &clnt);
            break;
        case SNS_SAM_TILT_DETECTOR_SVC_ID_V01:
            printf("PLAYBACK: TILT_DETECTOR Simulation requested\n");
            err = sns_plbk_sam_tilt_detector_enable(algo_attr->algo_config, &clnt);
            break;
        default:
            return;
    }
    ...
    switch(algo_attr->svc_id)
    {
        ...
        case SNS_SAM_GAME_ROTATION_VECTOR_SVC_ID_V01:
            ...
            break;
        case SNS_SAM_TILT_DETECTOR_SVC_ID_V01:
            sns_plbk_sam_tilt_detector_disable(&clnt);
            break;
        default:
            return;
    }
...
static int playback_get_algo_svc_id(char *str)
{
   ...
   } else if (!strcmp(str, "TILT_DETECTOR")) {
      return SNS_SAM_TILT_DETECTOR_SVC_ID_V01;
   } else {
      return -1;
   }
}
