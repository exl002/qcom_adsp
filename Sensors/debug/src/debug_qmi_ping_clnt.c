...
void debug_qmi_ping_client_thread(void *unused)
{
  ...
  qmi_idl_service_object_type ping_service_object = sns_smr_get_svc_obj(SNS_DEBUG_SVC_ID_V01);
  qmi_idl_service_object_type ping_diag_service_object = sns_smr_get_svc_obj(SNS_DIAG_DSPS_SVC_ID_V01);
