...
$Header: //components/rel/ssc.adsp/2.4.1/adsp_proc/Sensors/debug/src/sns_debug_dsps_str.c#1 $
...
static sns_debug_mask_t sns_diag_dsps_debug_mask = 0xffffffffffffffffULL;
...
uint8_t sns_debug_is_module_disabled(sns_debug_module_id_e module_id)
{
   ...
   */
  if ((sns_diag_dsps_debug_mask & (temp_i << module_id)) != 0)
  {
    ret_value = 1;
  }
  return ret_value;
