...
/* $Header: //components/rel/ssc.adsp/2.4.1/adsp_proc/Sensors/smgr/src/8994/sns_smgr_sensor_config.h#1 $ */
...
#define SNS_SMGR_DD_SELF_SCHED                          0x80
 ...
 #define SNS_SMGR_SENSOR_5_BUS_INSTANCE              7

 #define SNS_SMGR_SENSOR_6_ENUM_CODE                 SNS_SMGR_ID_RGB_V01
 #define SNS_SMGR_SENSOR_6_DD_FN_LIST_PTR            NULL
 #define SNS_SMGR_SENSOR_6_DEVICE_ID                 0
 #define SNS_SMGR_SENSOR_6_BUS_ADDRESS               0x39
 #define SNS_SMGR_SENSOR_6_DATA_TYPE_1               SNS_DDF_SENSOR_PROXIMITY
 #define SNS_SMGR_SENSOR_6_DATA_TYPE_2               SNS_DDF_SENSOR_AMBIENT
 ...
 #define SNS_SMGR_SENSOR_6_BUS_INSTANCE              2

 #define SNS_SMGR_SENSOR_7_ENUM_CODE                 SNS_SMGR_ID_SAR_V01
 #define SNS_SMGR_SENSOR_7_DD_FN_LIST_PTR            &sns_dd_sar_ad7146_fn_list
