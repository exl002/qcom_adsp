...
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*
  ...
  $Header: //components/rel/ssc.adsp/2.4.1/adsp_proc/Sensors/api/sns_sam_cmc_v01.h#3 $
 *====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*/
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====* 
...
#define SNS_SAM_CMC_MAX_ITEMS_IN_BATCH_V01 100

/**  Max number of supported motion states */
#define SNS_SAM_CMC_MS_NUM_V01 9
/**
    @}
  */
...
/** @addtogroup SNS_SAM_CMC_SVC_qmi_enums
  ...
  */
typedef enum {
  SNS_SAM_CMC_MS_EVENT_E_MIN_ENUM_VAL_V01 = -2147483647, /**< To force a 32 bit signed enum.  Do not change or use*/
  SNS_SAM_CMC_MS_EVENT_EXIT_V01 = 0, 
  SNS_SAM_CMC_MS_EVENT_ENTER_V01 = 1, 
  SNS_SAM_CMC_MS_EVENT_E_MAX_ENUM_VAL_V01 = 2147483647 /**< To force a 32 bit signed enum.  Do not change or use*/
}sns_sam_cmc_ms_event_e_v01;
/**
    @}
  */
...
/** @addtogroup SNS_SAM_CMC_SVC_qmi_enums
  ...
  */
typedef enum {
  SNS_SAM_CMC_MS_REPORT_TYPE_E_MIN_ENUM_VAL_V01 = -2147483647, /**< To force a 32 bit signed enum.  Do not change or use*/
  SNS_SAM_CMC_MS_REPORT_TYPE_ALL_V01 = 0, 
  SNS_SAM_CMC_MS_REPORT_TYPE_SINGLE_V01 = 1, 
  SNS_SAM_CMC_MS_REPORT_TYPE_E_MAX_ENUM_VAL_V01 = 2147483647 /**< To force a 32 bit signed enum.  Do not change or use*/
}sns_sam_cmc_ms_report_type_e_v01;
/**
    @}
  */
...
/** @addtogroup SNS_SAM_CMC_SVC_qmi_enums
  ...
  */
typedef enum {
  SNS_SAM_CMC_MS_EVENT_REPORT_TYPE_E_MIN_ENUM_VAL_V01 = -2147483647, /**< To force a 32 bit signed enum.  Do not change or use*/
  SNS_SAM_CMC_MS_EVENT_REPORT_TYPE_ENTER_V01 = 0, 
  SNS_SAM_CMC_MS_EVENT_REPORT_TYPE_EXIT_V01 = 1, 
  SNS_SAM_CMC_MS_EVENT_REPORT_TYPE_E_MAX_ENUM_VAL_V01 = 2147483647 /**< To force a 32 bit signed enum.  Do not change or use*/
}sns_sam_cmc_ms_event_report_type_e_v01;
/**
    @}
  */
...
typedef struct {
  ...
  uint32_t timestamp[SNS_SAM_CMC_MS_NUM_V01];
  ...
  sns_sam_cmc_report_data_s_v01 report_data[SNS_SAM_CMC_MS_NUM_V01];
...
typedef struct {
  ...
  sns_sam_cmc_ms_event_e_v01 ms_event;
...
typedef struct {
  ...
  */
}sns_sam_cmc_update_reporting_req_msg_v01;  /* Message */
/**
    @}
  */
...
typedef struct {
  ...
  uint8_t instance_id;
  /**<   Instance id identifies the algorithm instance.  */
}sns_sam_cmc_update_reporting_resp_msg_v01;  /* Message */
/**
    @}
  */
...
typedef struct {
  ...
  /**<   Optional request type
       ...
       Defaults to 0.
    */
}sns_sam_cmc_batch_req_msg_v01;  /* Message */
/**
    @}
  */
...
}sns_sam_cmc_batch_resp_msg_v01;  /* Message */
/**
    @}
  */
...
typedef struct {
  ...
  sns_sam_cmc_report_data_s_v01 report;
  /**<   cmc algorithm output report */

  sns_sam_cmc_ms_event_e_v01 ms_event;
  /**<   cmc motion state event type. */
}sns_sam_cmc_batch_item_s_v01;  /* Type */
/**
    @}
  */
...
typedef struct {
  ...
  sns_sam_cmc_batch_item_s_v01 items[SNS_SAM_CMC_MAX_ITEMS_IN_BATCH_V01];
  ...
  /**<   Optional batch indication type
    ...
    */
}sns_sam_cmc_batch_ind_msg_v01;  /* Message */
/**
    @}
  */
...
typedef struct {
  ...
  /**<   Specifies new interval (in seconds, Q16) over which reports are to be
    ...
    */
}sns_sam_cmc_update_batch_period_req_msg_v01;  /* Message */
/**
    @}
  */
...
typedef struct {
  ...
  uint32_t timestamp;
  /**<   Timestamp when the batch request was processed in SSC ticks */
}sns_sam_cmc_update_batch_period_resp_msg_v01;  /* Message */
/**
    @}
  */

/* Conditional compilation tags for message removal */ 
//#define REMOVE_SNS_SAM_CMC_BATCH_V01 
//#define REMOVE_SNS_SAM_CMC_BATCH_REPORT_V01 
...
//#define REMOVE_SNS_SAM_CMC_UPDATE_BATCH_PERIOD_V01 
//#define REMOVE_SNS_SAM_CMC_UPDATE_REPORTING_V01 
...
#define SNS_SAM_CMC_UPDATE_REPORTING_REQ_V01 0x0020
#define SNS_SAM_CMC_UPDATE_REPORTING_RESP_V01 0x0020
#define SNS_SAM_CMC_BATCH_REQ_V01 0x0021
#define SNS_SAM_CMC_BATCH_RESP_V01 0x0021
#define SNS_SAM_CMC_BATCH_IND_V01 0x0022
#define SNS_SAM_CMC_UPDATE_BATCH_PERIOD_REQ_V01 0x0023
#define SNS_SAM_CMC_UPDATE_BATCH_PERIOD_RESP_V01 0x0023
