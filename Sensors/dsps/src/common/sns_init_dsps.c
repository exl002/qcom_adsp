...
/*============================================================================
  ...
  $Header: //components/rel/ssc.adsp/2.4.1/adsp_proc/Sensors/dsps/src/common/sns_init_dsps.c#1 $
...
static void sns_init_once( void )
{
  ...
  for( i = 0; NULL != init_ptrs[i]; i++ ) {
    ...
    while( !(SNS_INIT_FLAG_DONE & flags) ) {
      ...
      flags = sns_os_sigs_accept( sns_init_flag_grp,
                                  SNS_INIT_FLAG_DONE,
    ...
    flags = sns_os_sigs_post( sns_init_flag_grp,
                              SNS_INIT_FLAG_DONE,
                              OS_FLAG_CLR,
                              &err );
  }
