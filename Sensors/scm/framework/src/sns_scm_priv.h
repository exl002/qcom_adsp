...
/* $Header: //components/rel/ssc.adsp/2.4.1/adsp_proc/Sensors/scm/framework/src/sns_scm_priv.h#2 $ */
/* $DateTime: 2014/06/24 12:15:10 $ */
/* $Author: pwbldsvc $ */
...
/*============================================================================
  ...
  ----------  ---  -----------------------------------------------------------
  2014-02-26  lka  Added fields to support dependent sensor types.
  2014-01-15  ks   SCM registry write triggered by sensor status change
  ...
  2011-08-09  rb   Ensured that SCM and SMGR registry group enums will always agree
  2011-08-04  rb   Added factory cal internal tracking in sns_scm_sensor_s
  2011-07-29  rb   Added enableAlgo to config structure.
  2011-07-20  ad   Refactor SCM for memory optimization
  2011-07-15  rb   Added registry data type
  2011-07-05  sc   Re-formated with UNIX newline ending
  2011-06-21  ad   updated gyro bias calibration algorithm
  2011-06-08  ad   reduced the internal database sizes to reduce memory use
...
#define  SCM_SAM_QCSI_TIMER_SIG        (0x1 << 4)

/* SCM - SMGR signals */
#define  SCM_SMGR_QCSI_WAIT_SIG        (0x1 << 5)
#define  SCM_SMGR_QCSI_TIMER_SIG       (0x1 << 6)

/* SCM - REG signals */
#define  SCM_REG_QCSI_WAIT_SIG         (0x1 << 7)
#define  SCM_REG_QCSI_TIMER_SIG        (0x1 << 8)
...
/* SCM QMI number of entries */
#define  SNS_SCM_SMGR_NUM_ENTRIES      1
#define  SNS_SCM_SAM_NUM_ENTRIES       1
#define  SNS_SCM_REG_NUM_ENTRIES       1
