...
/* $Header: //components/rel/ssc.adsp/2.4.1/adsp_proc/Sensors/sam/framework/src/8084/sns_sam_dsps_tgt.c#1 $ */
...
/*============================================================================
  ...
  2013-12-17  lka  Switches to buffering request if MD interrupt request fails.
