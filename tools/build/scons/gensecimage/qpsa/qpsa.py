...
#=============================================================================
#
#  $Header: //source/qcom/qct/images/scons/qc/rel/1.0/tools/build/scons/gensecimage/qpsa/qpsa.py#5 $
#  $DateTime: 2014/01/09 19:38:15 $
#  $Author: coresvc $
#  $Change: 5075494 $
...
if check_file_exists("qpsa.zip") == True:
    ...
    openssl_configfiles = ["opensslroot.cfg", "v3_attest.ext", "v3.ext", "QcomDevSigningToolDefaults.xml", "opensslroot.cfg"]
