...
===========================================================================*/
/* $Header: //components/rel/core.adsp/2.2/debugtrace/tracer/src/tracer_diag.h#2 $ */
...
/*-------------------------------------------------------------------------*/
/**
  @brief Request/Resonse header for DIAG packet service
...
/*-------------------------------------------------------------------------*/
/**
  @brief Request packet: Query for tracer output control and info
...
/**
  @brief Response packet: Query for tracer output control and info
...
/*-------------------------------------------------------------------------*/
/**
  @brief Request packet: Command to set tracer output control
...
/**
  @brief Response packet: Command to set tracer output control
...
/*-------------------------------------------------------------------------*/
/**
  @brief Request packet: Query for entity id's output state
...
/**
  @brief Response packet: Query for entity id's output state
...
/*-------------------------------------------------------------------------*/
/**
  @brief Request packet: Command to set entity id's output off or on
...
/**
  @brief Response packet: Command to set entity id's output off
  or on
...
/*-------------------------------------------------------------------------*/
/**
  @brief Request packet: Query sw event table tag
...
/**
  @brief Response packet: Query sw event table tag
...
/*-------------------------------------------------------------------------*/
/**
  @brief Request packet: Query for sw event id's output state
...
/**
  @brief Response packet: Query for sw event id's output state
...
/*-------------------------------------------------------------------------*/
/**
  @brief Request packet: Command to set tracer event id's output on or off
...
/**
  @brief Response packet: Command to set tracer event id's
  output on or off
...
/*-------------------------------------------------------------------------*/
/**
  @brief Request packet: Command for RPM to configure sw events
...
/**
  @brief Response packet: Command for RPM to configure sw events
...
/*-------------------------------------------------------------------------*/
/**
  @brief Request packet: Command to set the system test
         control register.
...
/**
  @brief Response packet: Command to set the system test
         control register.
...
/*-------------------------------------------------------------------------*/
/**
  @brief Initialize the interface for using diag's packet
         service.
 */
