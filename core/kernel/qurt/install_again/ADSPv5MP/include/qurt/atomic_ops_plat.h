...
$Header: //components/rel/core.adsp/2.2/kernel/qurt/libs/qurt/include/public/atomic_ops_plat.h#6 $ 
$DateTime: 2014/04/24 05:20:21 $ $Author: coresvc $

when       who     what, where, why
--------   ---     ------------------------------------------------------------
08/03/11   op      Add header file backward compatible
12/13/12   cm      (Tech Pubs) Edited/added Doxygen comments and markup.
=============================================================================*/
