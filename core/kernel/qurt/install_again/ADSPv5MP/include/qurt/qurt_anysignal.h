...
/*======================================================================
 	...
 	$Header: //components/rel/core.adsp/2.2/kernel/qurt/libs/qurt/include/public/qurt_anysignal.h#8 $ 
...
/**@ingroup func_qurt_anysignal_wait
  ...
  @param[in] mask   Signal mask value which identifies the individual signals in the any-signal
...
/**@ingroup func_qurt_anysignal_set
  ...
  @param[in]  mask  Signal mask value identifying the individual signals to be 
...
/**@ingroup func_qurt_anysignal_clear
  ...
  @param[in] signal Pointer to the any-signal object, specifies the any-signal object to modify. 
  @param[in] mask   Specifies a signal mask value which identifies the individual signals to be 
