...
===============================================================================
 ...
 $Header: //components/rel/core.adsp/2.2/hwengines/bam/9x35/bamtgtcfg.h#1 $
...
#define BAM_TGT_CFG_FORCEINIT          0x30 /**< Initialize the BAM even if EE index is not EE0.Used in SBL boot*/
