...
$Header: //components/rel/core.adsp/2.2/mproc/ipc_router/src/ipc_router_xal_smdl_qurt.c#2 $
...
#define IPC_ROUTER_XAL_SMDL_STACK_SIZE (2048)
...
{
  /* We do not allocate an IOV since we just typecast the packet
   * in convert_packet. So do nothing here. */
}
