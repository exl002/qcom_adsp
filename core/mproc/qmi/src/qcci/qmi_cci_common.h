...
/*=============================================================================
     Backward compatibility support for older version of qmi_client.h

     Provide required definitions in case the build tree does not have
     the newest version of qmi_client.h which provides definitions of
     qmi_client_release_cb and qmi_client_release_async
=============================================================================*/
#ifndef QMI_CLIENT_RELEASE_CB_SUPPORTED
typedef void (*qmi_client_release_cb)(void *cb_data);
...
#endif /* QMI_CLIENT_RELEASE_CB_SUPPORTED Not defined */
