...
$Header: //components/rel/core.adsp/2.2/mproc/qmi/src/common/qmi_loopback.c#1 $
...
#define CADDR2IDX(addr) (((addr) >> 2) & (QMI_LOOPBACK_CLNT_TBL_SIZE - 1))
...
)
{
  ...
  xp = (struct qmi_cci_lb_xport_handle *)handle;
  qmi_server_struct *i;
