...
$Header: //components/rel/core.adsp/2.2/dal/config/src/user/DALDeviceProp.c#2 $
...
const void **
DALSYS_GetPropStructPtrArray(DALProps * pInfo)
{
   return pInfo->pDALPROP_StructPtrs;
}
...
DALSYS_GetDALPropertyHandle(DALDEVICEID DeviceId,DALSYSPropertyHandle hDALProps)
{
   ...
   DALSYS_GetPropDir(&pDALPropsDir, 0);
