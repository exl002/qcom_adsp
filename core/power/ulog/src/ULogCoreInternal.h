...
$Header: //components/rel/core.adsp/2.2/power/ulog/src/ULogCoreInternal.h#2 $
============================================================================*/
...
typedef struct
{
  ...
  uint32 part1_size;
  uint32 part2_size;
  char* outputsz;              //This pointer is frequenctly moved forward  
...
typedef struct ULOG_STRUCT
{
  ...
  uint32 version;            // Version of this header.  Needed for logs that
                             // could exist across processors and to ensure the
                             // ULog parsing tools are appropriate for the log format. 
