...
$Header: //components/rel/core.adsp/2.2/power/spm/src/hal/HALspmPlatform.h#1 $
...
/**
 * Structure containing information of available command sequence
 * registers and pointer to program those registers.
 */
typedef struct HAL_spm_CSProgramInfoType
{
  /* Number of SLP_SEQ registers provided in SAW */
  uint32 numRegisters;

  /* Pointer to command sequence programming function */
  void (*progFcnPtr)( uint32 , BSP_spm_CmdSequenceType*);

  /* Last programmed sequence */
  BSP_spm_CmdSequenceType* lastSeq;

} HAL_spm_CSProgramInfoType;
