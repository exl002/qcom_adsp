...
$Header: //components/rel/core.adsp/2.2/power/spm/src/hal/BSPspm.h#1 $
...
typedef enum 
{
  BSP_SPM_SAW_PMIC_DATA_PC      = 0,
  BSP_SPM_SAW_PMIC_DATA_NOMINAL = 1,
...
/**
   @brief Container type for specifying the SPM command sequence for the
...
/**
 * Returns the number of power sequences that have specified in the platform.
 *
 * @Dependencies:
 *   SPM_NUM_CORES must be initialized.
