...
DESCRIPTION:  
  ...
  This data is for the 8974 v2 ADSP processor.
  Same data set as 9x25

                Copyright (c) 2012-2013 QUALCOMM Technologies Incorporated.
                All Rights Reserved.
                Qualcomm Confidential and Proprietary

$Header: //components/rel/core.adsp/2.2/power/spm/config/asic/8974v2/SPMDevCfgData.c#1 $
...
/* SPM command sequence for 8974v2 LPASS QDSP6 PC without RPM Handshake */
static uint8 spmCmdSeqBHS_8974v2[] =
{ 
  /* index 0 */
 ...
 */
BSP_spm_CmdSequenceType devcfgSpmCmdSeqArray_8974v2[][SPM_NUM_LOW_POWER_MODES] =
{
