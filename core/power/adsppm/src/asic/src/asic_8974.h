...
Adsppm_Status getBWFromMips_8974(AdsppmMIPSToBWAggaregateType *pMipsAggregateData);

Adsppm_Status getClockFromMips_8974(AdsppmMIPSToClockAggaregateType *pMipsAggregateData);
