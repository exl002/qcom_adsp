...
/*
 * adsspm_ConfigData.c - contains all 9x25-specific data definitions for Config Manager
 *
...
/**
 * Array of 9x25 core descriptors. Arranged according to core ID enum
 */
const AsicCoreDescType cores_9x25[Adsppm_Core_Id_Max] = {
        {   //Adsppm_Core_Id_None
...
const AsicMemDescType memories_9x25[Adsppm_Mem_Max] = {
        {   //Adsppm_Mem_None
...
/**
 * Array of 9x25 core clock descriptors. Arranged by core clock ID
 */
const AsicClkDescriptorType clocks_9x25[AdsppmClk_EnumMax] = {
        {
...
/**
 * Array of 9x25 Bus port descriptors arranged by Bus port ID
 */
const AsicBusPortDescriptorType busPorts_9x25[AdsppmBusPort_EnumMax] = {
        {
 ...
 */
const AdsppmBusRouteType extBusRoutes_9x25[] = {
        {
...
const AdsppmBusRouteType mipsBwRoutes_9x25[] =
{
      {
...
*/
const AdsppmClkIdType securityClocks_LPASSCore_9x25[] = 
{
 ...
 */
const AsicPowerDomainDescriptorType pwrDomains_9x25[AsicPowerDomain_EnumMax] = {
        {
        ...
        },
        {
                ...
                46, //TZ Done
                sizeof(securityClocks_LPASSCore_9x25)/sizeof(AdsppmClkIdType),
                &securityClocks_LPASSCore_9x25[0]
        },
        {
...
const AsicFeatureDescType features_9x25 [AsicFeatureId_enum_max] =
{
        ...
        //AsicFeatureId_Ahb_Scaling
        {
                ...
                524288000, //max bytes per second
        },
        ...
        {
                AsicFeatureState_Enabled,
                190, //min MIPS for periodic clients
                400  //max MIPS value
        },
