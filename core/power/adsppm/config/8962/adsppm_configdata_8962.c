...
/*
 * adsspm_ConfigData.c - contains all 8962-specific data definitions for Config Manager
 *
...
/**
 * Array of 8962 core descriptors. Arranged according to core ID enum
 */
const AsicCoreDescType cores_8962[Adsppm_Core_Id_Max] = {
        {   //Adsppm_Core_Id_None
...
const AsicMemDescType memories_8962[Adsppm_Mem_Max] = {
        {   //Adsppm_Mem_None
...
/**
 * Array of 8962 core clock descriptors. Arranged by core clock ID
 */
const AsicClkDescriptorType clocks_8962[AdsppmClk_EnumMax] = {
        {
...
/**
 * Array of 8962 Bus port descriptors arranged by Bus port ID
 */
const AsicBusPortDescriptorType busPorts_8962[AdsppmBusPort_EnumMax] = {
        {
 ...
 */
const AdsppmBusRouteType extBusRoutes_8962[] = {
        {
...
const AdsppmBusRouteType mipsBwRoutes_8962[] =
{
      {
...
*/
const AdsppmClkIdType securityClocks_LPASSCore_8962[] = 
{
 ...
 */
const AsicPowerDomainDescriptorType pwrDomains_8962[AsicPowerDomain_EnumMax] = {
        {
        ...
        },
        {
                ...
                46, //TZ Done
                sizeof(securityClocks_LPASSCore_8962)/sizeof(AdsppmClkIdType),
                &securityClocks_LPASSCore_8962[0]
        },
        {
...
const AsicFeatureDescType features_8962 [AsicFeatureId_enum_max] =
{
