...
/*
 * adsspm_ConfigData.c - contains all 8x10-specific data definitions for Config Manager
 *
...
/**
 * Array of 8x10 core descriptors. Arranged according to core ID
 * enum 
 */
const AsicCoreDescType cores_8x10[Adsppm_Core_Id_Max] = {
        {   //Adsppm_Core_Id_None
...
const AsicMemDescType memories_8x10[Adsppm_Mem_Max] = {
        {   //Adsppm_Mem_None
...
/**
 * Array of 8x10 core clock descriptors. Arranged by core clock ID
 */
const AsicClkDescriptorType clocks_8x10[AdsppmClk_EnumMax] = {
        {
...
/**
 * Array of 8x10 Bus port descriptors arranged by Bus port ID
 */
const AsicBusPortDescriptorType busPorts_8x10[AdsppmBusPort_EnumMax] = {
        {
 ...
 */
const AdsppmBusRouteType extBusRoutes_8x10[] = {
        {
...
const AdsppmBusRouteType mipsBwRoutes_8x10[] =
{
      {
 ...
 */
const AsicPowerDomainDescriptorType pwrDomains_8x10[AsicPowerDomain_EnumMax] = {
        {
...
const AsicFeatureDescType features_8x10 [AsicFeatureId_enum_max] =
{
