...
/*
 * adsspm_ConfigData.c - contains all 8x26-specific data definitions for Config Manager
 *
...
/**
 * Array of 8x26 core descriptors. Arranged according to core ID enum
 */
const AsicCoreDescType cores_8x26[Adsppm_Core_Id_Max] = {
        {   //Adsppm_Core_Id_None
...
const AsicMemDescType memories_8x26[Adsppm_Mem_Max] = {
        {   //Adsppm_Mem_None
...
/**
 * Array of 8x26 core clock descriptors. Arranged by core clock ID
 */
const AsicClkDescriptorType clocks_8x26[AdsppmClk_EnumMax] = {
        {
...
/**
 * Array of 8x26 Bus port descriptors arranged by Bus port ID
 */
const AsicBusPortDescriptorType busPorts_8x26[AdsppmBusPort_EnumMax] = {
        {
 ...
 */
const AdsppmBusRouteType extBusRoutes_8x26[] = {
        {
...
const AdsppmBusRouteType mipsBwRoutes_8x26[] =
{
      {
...
*/
const AdsppmClkIdType securityClocks_LPASSCore_8x26[] = 
{
 ...
 */
const AsicPowerDomainDescriptorType pwrDomains_8x26[AsicPowerDomain_EnumMax] = {
        {
        ...
        },
        {
                ...
                46, //TZ Done
                sizeof(securityClocks_LPASSCore_8x26)/sizeof(AdsppmClkIdType),
                &securityClocks_LPASSCore_8x26[0]
        },
        {
...
const AsicFeatureDescType features_8x26 [AsicFeatureId_enum_max] =
{
