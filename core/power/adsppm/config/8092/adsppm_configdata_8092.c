 ...
 */
const AsicCoreDescType cores_8092[Adsppm_Core_Id_Max] = {
        {   //Adsppm_Core_Id_None
...
const AsicMemDescType memories_8092[Adsppm_Mem_Max] = {
        {   //Adsppm_Mem_None
 ...
 */
const AsicClkDescriptorType clocks_8092[AdsppmClk_EnumMax] = {
        {
 ...
 */
const AsicBusPortDescriptorType busPorts_8092[AdsppmBusPort_EnumMax] = {
        {
 ...
 */
const AdsppmBusRouteType extBusRoutes_8092[] = {
        {
...
const AdsppmBusRouteType mipsBwRoutes_8092[] =
{
      {
 ...
 */
const AsicPowerDomainDescriptorType pwrDomains_8092[AsicPowerDomain_EnumMax] = {
        {
        ...
        },
        {
                ...
                46, //TZ Done
                sizeof(securityClocks_LPASSCore_8092)/sizeof(AdsppmClkIdType),
                &securityClocks_LPASSCore_8092[0]
        },
        {
