...
/*
 * adsspm_ConfigData.c - contains all 8084-specific data definitions for Config Manager
 *
...
/**
 * Array of 8084 core descriptors. Arranged according to core ID enum
 */
const AsicCoreDescType cores_8084[Adsppm_Core_Id_Max] = {
        {   //Adsppm_Core_Id_None
        ...
        {   //Adsppm_Core_Id_Spdif
                ...
                AsicPowerDomain_LpassCore, // Power Domain
                AdsppmBusPort_Spdif_Master, // Master port
                AdsppmBusPort_Spdif_Slave  // Slave port
        }
};

const AsicMemDescType memories_8084[Adsppm_Mem_Max] = {
        {   //Adsppm_Mem_None
...
/**
 * Array of 8084 core clock descriptors. Arranged by core clock ID
 */
const AsicClkDescriptorType clocks_8084[AdsppmClk_EnumMax] = {
        {
        ...
        },
		{
                ...
                AsicClk_TypeDalEnable, //Clk Type disabled until ClkRegime implements it
                AsicClk_CntlSW, // Cntl Type
                AsicClk_MemCntlNone, // MemCtrl Type
                "audio_core_avsync_avtimer_xo_clk", //"audio_core_avsync_avtimer_xo_clk",//Name
                AdsppmClk_None, //Source
                Adsppm_Mem_None //Memory ID
        },
		{
                ...
                AsicClk_CntlSW, // Cntl Type
                AsicClk_MemCntlNone, // MemCtrl Type
                "audio_core_avsync_atime_xo_clk",//"audio_core_avsync_atime_xo_clk",//Name
                AdsppmClk_None, //Source
                Adsppm_Mem_None //Memory ID
        },
...
/**
 * Array of 8084 Bus port descriptors arranged by Bus port ID
 */
const AsicBusPortDescriptorType busPorts_8084[AdsppmBusPort_EnumMax] = {
        {
        ...
        },
        {
                ...
                AdsppmClk_Smmu_Sysnoc_Hclk, //smmu clock
                {.icbarbMaster = ICBID_MASTER_LPASS_AHB}, // icbarb ID
                AdsppmBusPort_Ext_Ahb_Master // Access port
        },
        {
                ...
                AdsppmClk_Spdif_Hmclk, //Csr clock
                {.icbarbMaster = ICBID_MASTER_LPASS_AHB}, // icbarb ID
                AdsppmBusPort_Ext_Ahb_Master // Access port
        },
        {
        ...
        },
        {
                ...
                AdsppmClk_Spdif_Hsclk, //Csr clock
                {.icbarbSlave = ICBID_SLAVE_LPASS}, // icbarb ID
                AdsppmBusPort_Ext_Ahb_Slave // Access port
        }
};
 ...
 */
const AdsppmBusRouteType extBusRoutes_8084[] = {
        {
...
const AdsppmBusRouteType mipsBwRoutes_8084[] =
{
      {
...
*/
const AdsppmClkIdType securityClocks_LPASSCore_8084[] = 
{
 ...
 */
const AsicPowerDomainDescriptorType pwrDomains_8084[AsicPowerDomain_EnumMax] = {
        {
        ...
        },
        {
                ...
                46, //TZ Done
                sizeof(securityClocks_LPASSCore_8084)/sizeof(AdsppmClkIdType),
                &securityClocks_LPASSCore_8084[0]
        },
        {
...
const AsicFeatureDescType features_8084 [AsicFeatureId_enum_max] =
{
