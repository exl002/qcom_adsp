...
/*
 * adsspm_ConfigData.c - contains all 9x35-specific data definitions for Config Manager
 *
...
/**
 * Array of 9x35 core descriptors. Arranged according to core ID enum
 */
const AsicCoreDescType cores_9x35[Adsppm_Core_Id_Max] = {
        {   //Adsppm_Core_Id_None
...
const AsicMemDescType memories_9x35[Adsppm_Mem_Max] = {
        {   //Adsppm_Mem_None
...
/**
 * Array of 9x35 core clock descriptors. Arranged by core clock ID
 */
const AsicClkDescriptorType clocks_9x35[AdsppmClk_EnumMax] = {
        {
...
/**
 * Array of 9x35 Bus port descriptors arranged by Bus port ID
 */
const AsicBusPortDescriptorType busPorts_9x35[AdsppmBusPort_EnumMax] = {
        {
 ...
 */
const AdsppmBusRouteType extBusRoutes_9x35[] = {
        {
...
const AdsppmBusRouteType mipsBwRoutes_9x35[] =
{
      {
...
*/
const AdsppmClkIdType securityClocks_LPASSCore_9x35[] = 
{
 ...
 */
const AsicPowerDomainDescriptorType pwrDomains_9x35[AsicPowerDomain_EnumMax] = {
        {
        ...
        },
        {
                ...
                46, //TZ Done
                sizeof(securityClocks_LPASSCore_9x35)/sizeof(AdsppmClkIdType),
                &securityClocks_LPASSCore_9x35[0]
        },
        {
...
const AsicFeatureDescType features_9x35 [AsicFeatureId_enum_max] =
{
