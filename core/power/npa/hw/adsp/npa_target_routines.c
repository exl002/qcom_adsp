...
$Header: //components/rel/core.adsp/2.2/power/npa/hw/adsp/npa_target_routines.c#1 $
============================================================================*/
...
void npa_target_init( void )
{
  ...
  /* Publish sleep and PMIC resources; this must move to the relevant teams */
  npa_remote_publish_resources( SENSOR_PD, 6, sleep_resources );
