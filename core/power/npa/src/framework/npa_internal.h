...
$Header: //components/rel/core.adsp/2.2/power/npa/src/framework/npa_internal.h#2 $
============================================================================*/
...
/* Used to determine if the NPA scheduler exists in this build */
extern int npa_scheduler_exists;
...
{
  /* The active resource driver fcn */
  npa_resource_driver_fcn active_driver_fcn;
