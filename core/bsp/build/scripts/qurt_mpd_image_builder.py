...
#----------------------------------------------------------------------------
#
#  $Header: //components/rel/core.adsp/2.2/bsp/build/scripts/qurt_mpd_image_builder.py#1 $
...
def generate_mpd_boot_image(target, source, env):
   ...
   if (os.name == 'posix') : #linux
       obj_copy = "${QDSP6_RELEASE_DIR}/gnu/bin/qdsp6-objcopy";
       obj_dump = "${QDSP6_RELEASE_DIR}/gnu/bin/qdsp6-objdump";
       strip = "${QDSP6_RELEASE_DIR}/gnu/bin/qdsp6-strip";
       MPD_BOOT_IMG_BLDR = "${QDSP6_QURT_TOOLDIR}/qdsp6-image-build";
       
   else:                     #windows
       obj_copy = "${QDSP6_RELEASE_DIR}/gnu/bin/qdsp6-objcopy${EXE_EXT}";
       obj_dump = "${QDSP6_RELEASE_DIR}/gnu/bin/qdsp6-objdump${EXE_EXT}";
       strip = "${QDSP6_RELEASE_DIR}/gnu/bin/qdsp6-strip${EXE_EXT}";
