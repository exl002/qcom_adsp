...
import sys
sys.path.insert(1, "../../../../qdsp6/tools")
RELPATH = "../../qdsp6/tools"
RELPATH1 = "../../../../qdsp6/tools"
import os
import shutil
...
#------------------------------------------------------------------------------
# Switch to not use Qshrink for cstandalone builds
#------------------------------------------------------------------------------
if (os.path.exists(RELPATH1) ):         
         from QshrinkExe import *
...
def elfmergerutil_builder(target, source, env):
   ...
   if ( os.path.exists(RELPATH) ): 
     Qshrink_execution(tmp_merged_target, rootenv)
