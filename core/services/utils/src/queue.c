...
Copyright (c) 1990-2012 by Qualcomm Technologies Incorporated.  All Rights Reserved.
*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*/
...
$Header: //components/rel/core.adsp/2.2/services/utils/src/queue.c#1 $ $DateTime: 2013/04/03 17:22:53 $ $Author: coresvc $
