...
/*===========================================================================
 ...
 $Header: //components/rel/core.adsp/2.2/services/diag/DCM/common/src/diagcomm_io.h#1 $
...
typedef struct 
{
  ...
  boolean log_mask_preset_update[DIAG_MAX_PRESET_ID][EQUIP_ID_MAX];         /* Keeps track of which equip id log mask has been updated for Stream 1 */
  boolean log_mask_dci_update[DIAG_MAX_DCI_ID][EQUIP_ID_MAX];
#endif  
