...
/*===========================================================================
 ...
 $Header: //components/rel/core.adsp/2.2/services/diag/DCM/common/src/diagreset.c#1 $
...
boolean diag_gpio_init( void )
{
		...
		if(phTLMM==NULL)
		{
		  ...
		  {
			//MSG_ERROR("Failed to register with TLMM DAL",0, 0, 0);
			return FALSE;
		  }
		...
		if(phChipInfo==NULL)
		{
		  ...
		  {
			//MSG_ERROR("Failed to register with ChipInfo DAL",0, 0, 0);
			return FALSE;
		  }
