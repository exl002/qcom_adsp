...
/*===========================================================================
  ...
  $Header: //components/rel/core.adsp/2.2/services/diag/DCM/common/src/diagdsm_v.h#1 $
...
DESCRIPTION
  This function currently does nothing. Place holder for any clean-ups.
...
/*===========================================================================
FUNCTION DIAGDSM_DEINIT()

DESCRIPTION
  This function frees the memory allocated at diagdsm_init.
  This will be called upon unloading of diagdsm or windiag.
  Since these are built-in drivers, this will never be called,
  but is added to complement diagdsm_init().
