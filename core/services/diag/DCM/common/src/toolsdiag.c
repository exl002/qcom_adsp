...
$Header: //components/rel/core.adsp/2.2/services/diag/DCM/common/src/toolsdiag.c#1 $ $DateTime: 2013/04/03 17:22:53 $ $Author: coresvc $
...
#include "diagnv.h"
#include "toolsdiag.h"
#include "diagi_v.h"     /* For diag_strlcpy() */
...
/*- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -*/
  ...
  {   
    ...
    diag_strlcpy(str, mob_sw_rev, build_id_strlen);
  }
