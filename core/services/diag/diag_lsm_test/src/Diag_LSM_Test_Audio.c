...
$Header: //components/rel/core.adsp/2.2/services/diag/diag_lsm_test/src/Diag_LSM_Test_Audio.c#1 $
...
#define DIAG_TEST_APP_F_75            0x0FAA 
#define DIAG_TEST_APP_F_128           0x0FAB
#define DIAG_TEST_APP_F_128_DELAY     0x0FAC 
#define DIAG_TEST_APP_F_75_test       0x0FAD 
  ...
  if (rsp != NULL) {
    memcpy ((void *) rsp, (void *) req_pkt, pkt_len);
	  ...
	  event_report(EVENT_CAMERA_INVALID_STATE);
	   ...
	   MSG_HIGH("HELLO WORLDHIGH %d %d %d",1,2,3);
