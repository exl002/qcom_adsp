...
$Header: //components/rel/core.adsp/2.2/services/diag/platform/adsp/src/diagtask.c#2 $
...
void diagstart(void)
{
	...
	if (osal_set_sigs(&diag_tcb, DIAG_TASK_START_SIG, &return_sigs) != OSAL_SUCCESS)
	{
		fprintf(stderr, "diagstart: set_sigs failed\n");
