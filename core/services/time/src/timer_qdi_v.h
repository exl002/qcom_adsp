...
$Header: //components/rel/core.adsp/2.2/services/time/src/timer_qdi_v.h#6 $ 
...
#define TIMER_QDI_GET_TIME_TILL_FIRST_NON_DEFERRABLE_TIMER_64  (4+QDI_PRIVATE)
...
/* Call back method */
#define TIMER_QDI_GET_CB_INFO                (37+QDI_PRIVATE)
...
static inline int timer_invoke_get_time_till_first_non_deferrable_timer_64(int handle, time_timetick_type *tick)
{
   return qurt_qdi_handle_invoke(handle, TIMER_QDI_GET_TIME_TILL_FIRST_NON_DEFERRABLE_TIMER_64, tick);
}
