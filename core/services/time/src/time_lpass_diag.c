...
/*===========================================================================
  ...
  $Header: //components/rel/core.adsp/2.2/services/time/src/time_lpass_diag.c#2 $
...
)
{
  ...
  case LPASS_TIMER6_PRINT_ERR:
      MSG_HIGH("Not doing anything ",0,0,0);
      break;
  default :
      MSG_HIGH("LPASS_TIMER_DEBUG_time_lpass_diag: Error in command",0,0,0);
     break;
  }
