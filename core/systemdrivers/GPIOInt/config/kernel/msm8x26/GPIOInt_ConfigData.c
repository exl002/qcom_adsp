...
$Header: //components/rel/core.adsp/2.2/systemdrivers/GPIOInt/config/kernel/msm8x26/GPIOInt_ConfigData.c#3 $
...
GPIOIntConfigMapType interrupt_config_map[] =
{
  ...
  {62 ,          HAL_GPIOINT_SUMMARY,         GPIOINT_NONE,0}, /* Sensors GPIO in MultiPD is a summary interrupt*/
  {63 ,          HAL_GPIOINT_SUMMARY,         GPIOINT_NONE,0}, /* Sensors GPIO in MultiPD is a summary interrupt*/
