...
$Header: //components/rel/core.adsp/2.2/systemdrivers/GPIOInt/src/kernel/GPIOIntQDI.c#3 $
...
)
{
  ...
  GPIOInt_DisableInterrupt(pGPIOIntQdiData->pGPIOIntHdl, nGPIO);
...
)
{
  ...
  GPIOInt_EnableInterrupt(pGPIOIntQdiData->pGPIOIntHdl, (uint32)nGPIO);
  qurt_mutex_unlock(&GPIOIntQDILock); 
                          ...
                          qurt_qdi_arg_t a9)
{
  ...
  switch (method) 
  {
    ...
    case GPIOINT_QDI_REGISTER:
      return GPIOIntQDI_RegisterInterrupt(hClientHandle,a1.num,a2.num, a3.ptr);
