...
$Header: //components/rel/core.adsp/2.2/systemdrivers/GPIOInt/src/kernel/GPIOInt.c#4 $
...
)
{
   ...
   */ 
  for(nIdx =0; nIdx < device->gpioint_cntrl->gpio_number; nIdx++)
  {
    device->gpioint_cntrl->state[nIdx].intr_type = HAL_GPIOINT_SUMMARY;
  }
