...
$Header: //components/rel/core.adsp/2.2/systemdrivers/hal/clk/hw/v1/HALclkSRPLL.h#3 $
...
#define HWIO_PLL_CLK_SRC_SEL_OFFS                           0x00000020
...
#define HWIO_PLL_CLK_SRC_SEL_PLL_CLK_SRC_SEL_BMSK                  0x1
#define HWIO_PLL_CLK_SRC_SEL_PLL_CLK_SRC_SEL_SHFT                  0x0
 ...
 */
static void    HAL_clk_SRPLLEnable              ( HAL_clk_SourceDescType *pSource );
static void    HAL_clk_SRPLLDisable             ( HAL_clk_SourceDescType *pSource );
...
static void    HAL_clk_SRPLLConfigPLL           ( HAL_clk_SourceDescType *pSource, const HAL_clk_PLLConfigType *pmConfig );
static void    HAL_clk_SRPLLDetectPLLConfig     ( HAL_clk_SourceDescType *pSource, HAL_clk_PLLConfigType *pmConfig );
static void    HAL_clk_SRPLLEnableVote          ( HAL_clk_SourceDescType *pSource, boolean bAsync );
...
static void    HAL_clk_SRPLLEnableVoteOverride  ( HAL_clk_SourceDescType *pSource, HAL_clk_ClockDomainDescType *pmClkDomainDesc );
static void    HAL_clk_SRPLLDisableVoteOverride ( HAL_clk_SourceDescType *pSource, HAL_clk_ClockDomainDescType *pmClkDomainDesc );
