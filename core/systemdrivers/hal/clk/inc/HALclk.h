...
$Header: //components/rel/core.adsp/2.2/systemdrivers/hal/clk/inc/HALclk.h#6 $
...
typedef enum
{
  ...
  HAL_CLK_SOURCE_WCNPLL,
  HAL_CLK_SOURCE_MPLL0,
  HAL_CLK_SOURCE_MPLL1,
  HAL_CLK_SOURCE_MPLL2,
  HAL_CLK_SOURCE_MPLL3,
  HAL_CLK_SOURCE_APCSPLL0,
  HAL_CLK_SOURCE_APCSPLL1,
  HAL_CLK_SOURCE_APCSPLL2,
  HAL_CLK_SOURCE_APCSPLL3,
  HAL_CLK_SOURCE_APCSL2PLL,
...
void    HAL_clk_EnableSourceVote        ( HAL_clk_SourceType eSource, boolean bAsync );
...
void    HAL_clk_SlewConfigPLL           ( HAL_clk_SourceType eSource, const HAL_clk_PLLConfigType *pmConfig );
void    HAL_clk_EnableSourceOverride    ( HAL_clk_SourceType eSource, HAL_clk_ClockDomainHandleType pClockDomainHandle );
void    HAL_clk_DisableSourceOverride   ( HAL_clk_SourceType eSource, HAL_clk_ClockDomainHandleType pClockDomainHandle );
...
Parameters:
  ...
  bAsync - Asynchronous wait time. Setting to TRUE bypasses PLL lock time.
           Except where strictly required, this should always be set to FALSE.
