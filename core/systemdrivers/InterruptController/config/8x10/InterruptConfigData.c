...
$Header: //components/rel/core.adsp/2.2/systemdrivers/InterruptController/config/8x10/InterruptConfigData.c#1 $
...
static InterruptConfigType InterruptConfigs[] = 
{
 ...
 {114 ,    "a7ss_spare_bits_out[4]"},
 {115 ,    "a7ss_spare_bits_out[5]"},
 {116 ,    "a7ss_spare_bits_out[6]"},
 {117 ,    "a7ss_spare_bits_out[7]"},
 {INVALID_INTERRUPT , ""}
};
