...
$Header: //components/rel/core.adsp/2.2/systemdrivers/InterruptController/config/8084/InterruptConfigData.c#2 $
...
static InterruptConfigType InterruptConfigs[] =
{
  ...
  {44, "usb30_prim_power_event_irq"},
  {45, "usb30_prim_ee1_irq"},
  {46, "APCS_adspIPCInterrupt[3]"},
  {47, "usb30_prim_ee2_irq"},
  ...
  {110, "o_vpu_maple_qdsp_0_irq_out"},
  {111, "o_vpu_maple_qdsp_1_irq_out"},
  {122, "lpass_irq_out_apcs[11]"},
