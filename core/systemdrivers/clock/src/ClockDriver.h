...
/*
  ...
  $Header: //components/rel/core.adsp/2.2/systemdrivers/clock/src/ClockDriver.h#6 $
  $DateTime: 2013/10/18 01:42:57 $
  $Author: coresvc $
...
/**
  ...
  @param pCurrentRequest [in] -- The current voltage level and suppressibility
                                 settings.
  @param pNewRequest [in] -- The new voltage level and suppressibility
                             settings.
...
/**
  ...
  @param pHWVersion [in] - HW Version for comparison
...
DALResult Clock_SelectExternalSource( ClockDrvCtxt *pDrvCtxt,  ClockIdType  nClock,  uint32 nSource, uint32  nDivider,  uint32  nM,  uint32  nN,  uint32  n2D);
...
DALResult Clock_EnableAVS( ClockDrvCtxt *pDrvCtxt);
