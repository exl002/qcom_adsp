...
$Header: //components/rel/core.adsp/2.2/systemdrivers/clock/hw/lpass/inc/ClockLPASSCPU.h#4 $
 ...
 * HWVersion      - The chipset the configuration is supported on.  Leave value at '0'
