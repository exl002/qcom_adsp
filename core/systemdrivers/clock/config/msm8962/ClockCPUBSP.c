...
$Header: //components/rel/core.adsp/2.2/systemdrivers/clock/config/msm8962/ClockCPUBSP.c#2 $
...
/* HAL CLOCK MUX                       Freq. Hz        Source                 2*div         Voltage Corner                Voltage Ref        LDO Vdd     Headroom */
  ...
  {HAL_CLK_CONFIG_Q6SS_CORE_CLOCK_MUX, {595200 * 1000, {HAL_CLK_SOURCE_LPAPLL1,  2}, CLOCK_VREG_LEVEL_HIGH},    CLOCK_CPU_VREG_LEVEL_HIGH_UV },
};
