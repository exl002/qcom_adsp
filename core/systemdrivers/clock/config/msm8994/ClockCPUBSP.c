...
$Header: //components/rel/core.adsp/2.2/systemdrivers/clock/config/msm8994/ClockCPUBSP.c#1 $
...
{
/* HAL CLOCK MUX                       Freq. Hz        Source                 2*div         Voltage Corner                Voltage Ref        LDO Vdd     Headroom */
  {HAL_CLK_CONFIG_Q6SS_CORE_CLOCK_MUX, {  9600 * 1000, {HAL_CLK_SOURCE_XO,       4}, CLOCK_VREG_LEVEL_LOW},     CLOCK_CPU_VREG_LEVEL_LOW_UV, 700 * 1000, 78500}, 
  {HAL_CLK_CONFIG_Q6SS_CORE_CLOCK_MUX, { 19200 * 1000, {HAL_CLK_SOURCE_XO,       2}, CLOCK_VREG_LEVEL_LOW},     CLOCK_CPU_VREG_LEVEL_LOW_UV, 700 * 1000, 78500}, 
  {HAL_CLK_CONFIG_Q6SS_CORE_CLOCK_MUX, { 49152 * 1000, {HAL_CLK_SOURCE_LPAPLL0, 20}, CLOCK_VREG_LEVEL_LOW},     CLOCK_CPU_VREG_LEVEL_LOW_UV, 700 * 1000, 78500},
  {HAL_CLK_CONFIG_Q6SS_CORE_CLOCK_MUX, { 61440 * 1000, {HAL_CLK_SOURCE_LPAPLL0, 16}, CLOCK_VREG_LEVEL_LOW},     CLOCK_CPU_VREG_LEVEL_LOW_UV, 700 * 1000, 78500},
  {HAL_CLK_CONFIG_Q6SS_CORE_CLOCK_MUX, { 81920 * 1000, {HAL_CLK_SOURCE_LPAPLL0, 12}, CLOCK_VREG_LEVEL_LOW},     CLOCK_CPU_VREG_LEVEL_LOW_UV, 700 * 1000, 78500},
  {HAL_CLK_CONFIG_Q6SS_CORE_CLOCK_MUX, {122880 * 1000, {HAL_CLK_SOURCE_LPAPLL0,  8}, CLOCK_VREG_LEVEL_LOW},     CLOCK_CPU_VREG_LEVEL_LOW_UV, 700 * 1000, 78500}, 
  ...
  {HAL_CLK_CONFIG_Q6SS_CORE_CLOCK_MUX, {340000 * 1000, {HAL_CLK_SOURCE_LPAPLL1,  4}, CLOCK_VREG_LEVEL_LOW},     CLOCK_CPU_VREG_LEVEL_LOW_UV },
  ...
  {HAL_CLK_CONFIG_Q6SS_CORE_CLOCK_MUX, {680000 * 1000, {HAL_CLK_SOURCE_LPAPLL1,  2}, CLOCK_VREG_LEVEL_HIGH},    CLOCK_CPU_VREG_LEVEL_HIGH_UV }, 
};
