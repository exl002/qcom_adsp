...
$Header: //components/rel/core.adsp/2.2/systemdrivers/clock/config/msm8994/ClockBSP.c#1 $
...
const ClockSourceConfigType SourceConfig[] =
{
  ...
  /*-----------------------------------------------------------------------*/
  /* LPAPLL1 - LPASS Q6 PLL for V2 HW                                      */
  /*-----------------------------------------------------------------------*/  
...
/*
 * MIDI clock configurations.
 */
const ClockMuxConfigType MIDIClockConfig[] =
{
  { 109227 * 1000, { HAL_CLK_SOURCE_LPAPLL0, 9, 0, 0, 0 }, CLOCK_VREG_LEVEL_NOMINAL },
  { 122880 * 1000, { HAL_CLK_SOURCE_LPAPLL0, 8, 0, 0, 0 }, CLOCK_VREG_LEVEL_NOMINAL },
  { 140434 * 1000, { HAL_CLK_SOURCE_LPAPLL0, 7, 0, 0, 0 }, CLOCK_VREG_LEVEL_NOMINAL },
  { 0 }
};
