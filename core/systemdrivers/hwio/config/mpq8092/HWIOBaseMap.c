...
/*
  ...
  $Header: //components/rel/core.adsp/2.2/systemdrivers/hwio/config/mpq8092/HWIOBaseMap.c#2 $
...
static HWIOModuleType HWIOModules_PERIPH_SS[] =
{
  ...
  { "PERIPH_SS_USB2_HSIC_USB_OTG_HS_BASE",         0x00200000, 0x00001000 },
  { "PERIPH_SS_USB2_HSIC_VMIDMT",                  0x00201000, 0x00001000 },
  { "PERIPH_SS_USB2_HSIC_USB_OTG_HS_XPU2",         0x00202000, 0x00002000 },
  ...
  { "PERIPH_SS_USB_HS_SEC_USB_OTG_HS_BASE",        0x00295000, 0x00001000 },
  { "PERIPH_SS_USB_HS_SEC_BAM",                    0x00284000, 0x00011000 },
  { "PERIPH_SS_USB_HS_SEC_XPU2",                   0x00282000, 0x00002000 },
  { "PERIPH_SS_USB_HS_SEC_VMIDMT",                 0x00280000, 0x00001000 },
  { "PERIPH_SS_PWM_WEB_PWM",                       0x00300000, 0x0000c000 },
  { "PERIPH_SS_PDM_WEB_TCXO4",                     0x00310000, 0x00004000 },
  { "PERIPH_SS_GENI_IR_TX_IR_IR_GENI_CFG",         0x003f6000, 0x00000700 },
  { "PERIPH_SS_GENI_IR_TX_IR_IR_IR_CFG",           0x003f6800, 0x00000100 },
  { "PERIPH_SS_GENI_IR_TX_IR_IR_GENI_DATA",        0x003f6c00, 0x000000e4 },
...
static HWIOModuleType HWIOModules_QDSS_APB[] =
{
  { "DAPROM",                                      0x00000000, 0x00001000 },
  { "QDSSCSR",                                     0x00001000, 0x00001000 },
  { "CXSTM_2_32_32_TRUE",                          0x00002000, 0x00001000 },
  { "CTI0_CSCTI",                                  0x00010000, 0x00001000 },
  { "CTI1_CSCTI",                                  0x00011000, 0x00001000 },
  { "CTI2_CSCTI",                                  0x00012000, 0x00001000 },
  { "CTI3_CSCTI",                                  0x00013000, 0x00001000 },
  { "CTI4_CSCTI",                                  0x00014000, 0x00001000 },
  { "CTI5_CSCTI",                                  0x00015000, 0x00001000 },
  { "CTI6_CSCTI",                                  0x00016000, 0x00001000 },
  { "CTI7_CSCTI",                                  0x00017000, 0x00001000 },
  { "CTI8_CSCTI",                                  0x00018000, 0x00001000 },
  { "CSTPIU_CSTPIU",                               0x00020000, 0x00001000 },
  { "IN_FUN0_CXATBFUNNEL_128W8SP",                 0x00021000, 0x00001000 },
  { "IN_FUN1_CXATBFUNNEL_128W8SP",                 0x00022000, 0x00001000 },
  { "MERG_FUN_CXATBFUNNEL_128W2SP",                0x00023000, 0x00001000 },
  { "REPL64_CXATBREPLICATOR_64WP",                 0x00024000, 0x00001000 },
  { "ETFETB_CXTMC_F128W64K",                       0x00025000, 0x00001000 },
  { "ETR_CXTMC_R64W32D",                           0x00026000, 0x00001000 },
  { NULL, 0, 0 }
};

static HWIOModuleType HWIOModules_QDSS_AHB[] =
{
  { "VMIDDAP_VMIDMT_IDX_2_SSD1",                   0x00006000, 0x00001000 },
  { "VMIDETR_VMIDMT_IDX_2_SSD1",                   0x00007000, 0x00001000 },
  { "NDPBAM_BAM",                                  0x0000c000, 0x00003000 },
  { NULL, 0, 0 }
};
...
{
  { "SYSTEM_NOC",                                  0x00000000, 0x00004780 },
  { NULL, 0, 0 }
};
...
{
  { "LPASS_LPASS_CC_REG",                          0x00000000, 0x00048000 },
  ...
  { "LPASS_ATIMER",                                0x000cb000, 0x00000100 },
  { "LPASS_BSTC_MEM",                              0x000ce600, 0x000005fd },
  { "LPASS_BSTC_REG",                              0x000cec00, 0x000003fd },
  { "LPASS_ATIMER2",                               0x000cf000, 0x00000100 },
  ...
  { "LPASS_HDMI_VMT",                              0x00120000, 0x00001000 },
  { "LPASS_SPDIF_VMT",                             0x00121000, 0x00001000 },
  { "LPASS_LPASS_SIF_AUD_DEC",                     0x00132000, 0x00001000 },
  { "LPASS_SPDIFTX",                               0x00133000, 0x00001000 },
  { "LPASS_HDMIRX",                                0x00134000, 0x00001000 },
...
HWIOPhysRegionType HWIOBaseMap[] =
{
  ...
  },
  {
    ...
    0x00028000,
    (DALSYSMemAddr)QDSS_APB_BASE,
    HWIOModules_QDSS_APB
  },
  {
    "QDSS_AHB",
    (DALSYSMemAddr)0xfc370000,
    0x00018000,
    (DALSYSMemAddr)QDSS_AHB_BASE,
    HWIOModules_QDSS_AHB
  },
  {
    "CLK_CTL",
