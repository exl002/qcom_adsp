...
#  ===========================================================================
#
#  $Header: //components/rel/core.adsp/2.2/systemdrivers/hwio/build/hwio_msm8994.py#2 $
...
base_resize = {
  'CONFIG_NOC':                      0x1000,
  'SYSTEM_NOC':                      0x5000, # Changed to match Gandalf
  'MPM2_MPM':                        0xC000,
  'RPM':                            0x90000,
  ...
  'CLK_CTL':                        0x20000,
  'PMIC_ARB':                       0x10000,
  'PERIPH_SS':                     0x500000, # Changed to match Gandalf
  'QDSS_QDSS':                      0x80000,
