#===========================================================================
#
#  @file hwio_msm8x26.py
#  @brief HWIO config file for the HWIO generation scripts for MSM8x26
#         LPASS.
#
#  This file can be invoked by calling:
#
#    HWIOGen.py --cfg=hwio_msm8x26.py --flat=..\..\..\api\systemdrivers\hwio\msm8x26\ARM_ADDRESS_FILE.FLAT
#
#  ===========================================================================
#
...
#  ===========================================================================
#
#  $Header: //components/rel/core.adsp/2.2/systemdrivers/hwio/build/hwio_msm8x26.py#2 $
...
base_resize = {
  'CONFIG_NOC':                      0x1000,
  'SYSTEM_NOC':                      0x5000, # Increased to match Gandalf
  'MPM2_MPM':                        0xC000,
  'RPM':                            0x90000,
  ...
  'CLK_CTL':                        0x20000,
  'PMIC_ARB':                       0x10000,
  'PERIPH_SS':                     0x500000, # Increased to match Gandalf
  'QDSS_QDSS':                      0x80000,
