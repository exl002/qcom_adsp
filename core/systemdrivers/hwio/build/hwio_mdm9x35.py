#===========================================================================
#
#  @file hwio_mdm9x35.py
#  @brief HWIO config file for the HWIO generation scripts for MDM9x35
#         LPASS.
#
#  This file can be invoked by calling:
#
#    HWIOGen.py --cfg=hwio_mdm9x35.py --flat=..\..\..\api\systemdrivers\hwio\mdm9x35\ARM_ADDRESS_FILE.FLAT
#
#  ===========================================================================
#
...
#  ===========================================================================
#
#  $Header: //components/rel/core.adsp/2.2/systemdrivers/hwio/build/hwio_mdm9x35.py#1 $
