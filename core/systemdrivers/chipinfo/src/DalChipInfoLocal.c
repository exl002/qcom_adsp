...
============================================================================
  $Header: //components/rel/core.adsp/2.2/systemdrivers/chipinfo/src/DalChipInfoLocal.c#11 $
  $DateTime: 2013/10/01 18:00:06 $
  $Author: coresvc $
...
DalChipInfoIdMapType chipIdMap[] =
{
  ...
  { DALCHIPINFO_ID_MSM8510, 54  },
  { DALCHIPINFO_ID_MSM8512, 55  },
};
