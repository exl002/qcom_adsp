...
$Header: //components/rel/core.adsp/2.2/systemdrivers/pmic/config/mdm9x25/pm_lpass_settings.c#1 $ 

when       who     what, where, why
--------   ---     ----------------------------------------------------------
11/28/12   dcf     Ported to dev-cfg.
...
static char PM_MODEM_CX_VREG[50] = "/pmic/device/ldo/A/ldo10/vec";

static unsigned num_of_mx_corners = 6;
static unsigned pm_mx_corners[6] = 
{675000, 950000, 950000, 950000, 1050000, 1050000};
static char PM_MODEM_MX_VREG[50] = "/pmic/device/ldo/A/ldo12/vec";

PwrResourceInfoType MX_Info[1] = 
{
    {RPM_LDO_A_REQ, 12, &num_of_mx_corners, pm_mx_corners, PM_MODEM_MX_VREG }// data 1 is the size of the LUT, data 2 is the MX LUT, data3 is the RPM resource string 
};
PwrResourceInfoType CX_Info[1] = 
{
    {RPM_LDO_A_REQ, 10, &num_of_cx_corners, pm_cx_corners, PM_MODEM_CX_VREG }// data 1 is the size of the LUT, data 2 is the CX LUT, data3 is the RPM resource string.
};
