...
$Header: //components/rel/core.adsp/2.2/systemdrivers/pmic/config/msm8x26/pm_lpass_proc_pam.c#9 $ 
...
8/21/2012	agnerw	MSM8974 branch 1.0 ver 8_21_2012 - NOT Approved 1.Version Notes:
...
{
   {
      (void*)pm_pam_slimbus_a_ldo3,
      PM_NPA_VREG_LDO
   },
   {
      (void*)pm_pam_slimbus_a_smps1,
      PM_NPA_VREG_SMPS
   },
};
...
static pm_npa_ldo_kvps
pm_pam_sensor_dsp_proxy_a_ldo19[] =
{
...
{
   {
      (void*)pm_pam_sensor_dsp_proxy_a_ldo19,
      PM_NPA_VREG_LDO
   },
   {
...
unsigned num_of_pmic_lpass_nodes[] = { 6 };
...
{  
   ...
   {
     PMIC_DEV_RSRC_NAME_VEC_IN( A, ldo, 19),
     "ldoa\x13\x00\x00\x00",
   }
};
