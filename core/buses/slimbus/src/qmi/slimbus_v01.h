#ifndef SLIMBUS_SERVICE_H
#define SLIMBUS_SERVICE_H
/**
  @file slimbus_v01.h
...
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*
  ...
  $Header: //components/rel/core.adsp/2.2/buses/slimbus/src/qmi/slimbus_v01.h#1 $
 *====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*/
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====* 
...
/* This file was generated with Tool version 5.6 
   It was generated on: Fri Oct 12 2012
...
#define SLIMBUS_V01_IDL_MINOR_VERS 0x00
/** Major Version Number of the qmi_idl_compiler used to generate this file */
#define SLIMBUS_V01_IDL_TOOL_VERS 0x05
/** Maximum Defined Message ID */
#define SLIMBUS_V01_MAX_MESSAGE_ID 0x0021;
/** 
    @} 
  */
...
typedef enum {
  ...
  SLIMBUS_MODE_SATELLITE_V01 = 1, /**<  Request satellite mode  */
  SLIMBUS_MODE_MASTER_V01 = 2, /**<  Request master mode  */
...
/** @addtogroup slimbus_qmi_messages
    @{
  */
/** Request Message; This command selects the Slimbus hardware instance 
                      that will be used for subsequent commands. */
typedef struct {

  /* Mandatory */
  /*  Hardware Instance Selection */
  uint32_t instance;
  /**<   The zero-based Slimbus hardware instance selected. */

  /* Optional */
  /*  Mode Request Operation */
  uint8_t mode_valid;  /**< Must be set to true if mode is being passed */
  slimbus_mode_enum_type_v01 mode;
  /**<   The software driver mode requested. Values: \n
      - SLIMBUS_MODE_SATELLITE (1) --  Request satellite mode 
      - SLIMBUS_MODE_MASTER (2) --  Request master mode  */
...
/** @addtogroup slimbus_qmi_messages
    @{
  */
/** Response Message; This command selects the Slimbus hardware instance 
                      that will be used for subsequent commands. */
typedef struct {
...
typedef enum {
  ...
  SLIMBUS_PM_INACTIVE_V01 = 1, /**<  Request that Slimbus hardware be allowed to be idle  */
  SLIMBUS_PM_ACTIVE_V01 = 2, /**<  Request that Slimbus hardware be in the active state  */
...
/** @addtogroup slimbus_qmi_messages
    @{
  */
/** Request Message; This command performs a power request for Slimbus. */
typedef struct {

  /* Mandatory */
  /*  Power Request Operation */
  slimbus_pm_enum_type_v01 pm_req;
  /**<   The Slimbus hardware power state requested. Values: \n
      - SLIMBUS_PM_INACTIVE (1) --  Request that Slimbus hardware be allowed to be idle 
      - SLIMBUS_PM_ACTIVE (2) --  Request that Slimbus hardware be in the active state  */
...
/** @addtogroup slimbus_qmi_messages
    @{
  */
/** Response Message; This command performs a power request for Slimbus. */
typedef struct {
