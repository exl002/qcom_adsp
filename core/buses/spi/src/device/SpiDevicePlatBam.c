...
$Header: //components/rel/core.adsp/2.2/buses/spi/src/device/SpiDevicePlatBam.c#2 $

When           Who    What, where, why
--------      ---    -----------------------------------------------------------
08/27/13      vk     Bugfix PA, VA swap in IBUSOSSPI_PhysMemAlloc
04/07/12      ddk    Added updates for de-init.
03/14/12      ddk    Added updates for pipe management.
02/09/12      ddk    Initial creation.

===========================================================================
        Copyright c 2012-13 Qualcomm Technologies Incorporated.
            All Rights Reserved.
