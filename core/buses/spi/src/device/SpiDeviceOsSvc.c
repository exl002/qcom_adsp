...
$Header: //components/rel/core.adsp/2.2/buses/spi/src/device/SpiDeviceOsSvc.c#1 $
...
IBUSOS_CreateEvent(IBUSOS_EVENT_HANDLE *phEvt)
{
   ...
   do 
   {
      ...
      {
         IBUSLOG_LOG_LEVEL_1(0,"IBUSOS_CreateEvent: Malloc failure\n");
         break;
      }
      ...
      if (dalRes != DAL_SUCCESS)
      {
         ...
         IBUSLOG_LOG_LEVEL_1(1,"IBUSOS_CreateEvent: Dal failure err 0x%x\n",
                      (unsigned int)dalRes );
         break; 
      }
