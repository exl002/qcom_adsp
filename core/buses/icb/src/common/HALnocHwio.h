...
$Header: //components/rel/core.adsp/2.2/buses/icb/src/common/HALnocHwio.h#1 $
...
#define NOC_INI(base,regsym,index)               __nochwio_ini(base,regsym,index)
...
#define NOC_INMI(base,regsym,index,mask)         __nochwio_inmi(base,regsym,index,mask)
...
#define NOC_OUTI(base,regsym,index,val)          __nochwio_outi(base,regsym,index,val)
...
#define NOC_OUTMI(base,regsym,index,mask,val)    __nochwio_outmi(base,regsym,index,mask,val)
...
#define NOC_ADDRI(base,regsym,index)             __nochwio_addri(base,regsym,index)
...
#define NOC_INFI(base,regsym,index,field)         (NOC_INMI(base,regsym,index,NOC_FMSK(regsym,field)) >> NOC_SHFT(regsym,field))
...
#define NOC_OUTFI(base,regsym,index,field,val)    NOC_OUTMI(base,regsym,index,NOC_FMSK(regsym, field), val << NOC_SHFT(regsym, field))
...
#define __nochwio_ini(base,regsym,index)               NOC_##regsym##_INI(base,index)
...
#define __nochwio_inmi(base,regsym,index,mask)         NOC_##regsym##_INMI(base,index,mask)
...
#define __nochwio_outi(base,regsym,index,val)          NOC_##regsym##_OUTI(base,index,val)
...
#define __nochwio_outmi(base,regsym,index,mask,val)    NOC_##regsym##_OUTMI(base,index,mask,val)
...
#define __nochwio_addri(base,regsym,index)             NOC_##regsym##_ADDR(base,index)
