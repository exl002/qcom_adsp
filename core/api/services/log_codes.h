...
$Header: //components/rel/core.adsp/2.2/api/services/log_codes.h#7 $
...
#define LOG_EMBMS_SL_LAST_C                                (99 + LOG_EMBMS_SL_RESERVED_CODES_BASE_C)    /*0x1760*/
...
#define LOG_1X_LAST_C                           ((0x83E) + LOG_1X_BASE_C)
