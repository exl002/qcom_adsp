...
$Header: //components/rel/core.adsp/2.2/api/debugtools/err.h#2 $
...
void err_SaveFatal3 (const msg_const_type* const_blk, uint32 code1, uint32 code2, uint32 code3) ERR_NORETURN_ATTRIBUTE;
void err_SaveFatal0 (const msg_const_type* const_blk) ERR_NORETURN_ATTRIBUTE;
