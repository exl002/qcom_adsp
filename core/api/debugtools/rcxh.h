...
/**
@file rcxh.h
@brief This file contains the API details for the Exception Handling service.
*/
/*=============================================================================
...
/*=============================================================================
Edit History
$Header: //components/rel/core.adsp/2.2/api/debugtools/rcxh.h#1 $
...
struct _rcxh_s __rcxh_undef;                                                     /**< internal, undefined exception, base "class", undefined */
struct _rcxh_s* _rcxh_undef;                                                     /**< internal, undefined exception, base "class", undefined */
...
*/
#define RCXH_EXT(name)        struct _rcxh_s _rcxh_##name; struct _rcxh_s* rcxh_##name
...
*/
#define RCXH_TRY              do { _rcxh_scope_t _rcxh_scope; _rcxh_scope_init(&_rcxh_scope); if (RCXH_FALSE == setjmp(_rcxh_scope.frame)) {
...
*/
#define RCXH_ENDTRY           } _rcxh_end(&_rcxh_scope); } while(0);
