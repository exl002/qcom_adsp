...
$Header: //components/rel/core.adsp/2.2/api/power/npa_resource.h#2 $
==========================================================================*/
...
typedef enum
{
  ...
  /* Allow NPA scheduler to fork this resource in the LPR */
 ...
 *
 * Stub resources are used to satsify dependencies, similiar to
 ...
 *
 * Note: This plugin uses all of the internal state vector*/
