...
struct DalTF
{
   ...
   DALResult (*GetRetBuf)(DalDeviceHandle *,uint32 ,void **,uint32 *);
   DALResult (*GetFirstTest)(DalDeviceHandle *,void **,uint32 *);
   DALResult (*GetNextTest)(DalDeviceHandle *,void **,uint32 *);
};
...
void DalTF_MsgEx(uint32 dwTestID, const char *format, ...);
...
{
    return ((DalTFHandle *)_h)->pVtbl->GetFirstTest( _h,ppSyncBuf,dwSyncBufSize);
}
...
{
    return ((DalTFHandle *)_h)->pVtbl->GetNextTest( _h,ppSyncBuf,dwSyncBufSize);
}
...
*/
static __inline DALResult DalTF_GetRetBuf(DalDeviceHandle *_h,uint32 dwTestCaseID,void **ppRetBuf,uint32 *dwRetBufSize)
{
   return ((DalTFHandle *)_h)->pVtbl->GetRetBuf(_h,dwTestCaseID,ppRetBuf,dwRetBufSize);
}
