...
===============================================================================
 ...
 $Header: //components/rel/core.adsp/2.2/api/hwengines/bam.h#2 $
...
typedef enum
{
    ...
    BAM_O_POLL              = 0x01000000,  /**< Transfer operation should be polled */
    BAM_O_NO_Q              = 0x02000000,  /**< Disable queuing of transfer events for the connection end point */
    BAM_O_WAKEUP_IS_ONESHOT = 0x08000000,  /**< BAM_O_WAKEUP will be disabled after triggered */
    BAM_O_ACK_TRANSFERS     = 0x10000000,  /**< Client must read each descriptor from the FIFO using bam_pipe_getiovec() */
    BAM_O_AUTO_ENABLE       = 0x20000000,  /**< Connection is automatically enabled */
   BAM_O_ACK_LAST_ONLY     = 0x40000000,  /**< No acknowledgement for all processed descriptors.
