...
$Header: //components/rel/core.adsp/2.2/debugtools/err/src/err_void.c#2 $
...
void err_bootstrap_exception_handler(void) { /* NULL */ }
...
//void err_SaveFatal2 (const msg_const_type* const_blk, uint32 code1, uint32 code2) { /* NULL */ };
//void err_SaveFatal1 (const msg_const_type* const_blk, uint32 code1) { /* NULL */ };
