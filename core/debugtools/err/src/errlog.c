...
/*===========================================================================
 ...
 $Header: //components/rel/core.adsp/2.2/debugtools/err/src/errlog.c#2 $ $DateTime: 2014/07/24 05:52:16 $ $Author: pwbldsvc $
...
DESCRIPTION
  ...
  and VA_ARGS parameters to the snprintf function. Upon returning, the
