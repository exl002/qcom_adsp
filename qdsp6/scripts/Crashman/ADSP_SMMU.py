...
def create_smmutxt():
    ...
    smmu_files_list = ['msm_iommu_domain_01.txt','msm_iommu_domain_02.txt']
    
    for smmu_files in smmu_files_list:
...
def main():
    ...
    for line_dsppgt in f_dsppgt:
        if ( line_dsppgt[0:2] == '0x'):
            ...
            vpage_address = int(list_dsppgt[0],16)
            vpage_address = vpage_address * 0x1000
            ipage_address= int(list_dsppgt[1],16)
            ipage_address = ipage_address * 0x1000
            size= int(list_dsppgt[2],16)
            #print line_dsppgt
