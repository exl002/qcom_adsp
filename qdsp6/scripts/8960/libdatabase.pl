...
sub getHeaderInfoFromImage {
   print " Retrieve physical to virtual tables of each sections from image\(qdsp6-objdump\)\n";
   system ("qdsp6-objdump ./obj/qdsp6v4_ReleaseG/bootimg.pbn -h -w > $ABS_DIR_SPT_OUTPUT/section_info.txt");
