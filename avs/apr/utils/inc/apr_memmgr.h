...
Copyright (C) 1997-2012, 2013 by QUALCOMM Technologies, Incorporated.  All Rights Reserved.
===========================================================================*/
...
$Header: //source/qcom/qct/images/adsp/avs/rel/2.2/adsp_proc/avs/apr/utils/inc/apr_memmgr.h#12 $ $DateTime: 2013/06/12 07:44:04 $ $Author: coresvc $

when       who     what, where, why
--------   ---     --------------------------------------------------------
08/29/12   lkc     Changed the implementation to wrap memheap2
 ...
 * for the heap header
 */
#define APR_MEMMGR_OPAQUE_DATASIZE (0x800)
#define APR_MEM_ALIGN_64(x) ( (uint32_t)((char*)x + 7) & (~7) )
