...
$Header: //source/qcom/qct/images/adsp/avs/rel/2.2/adsp_proc/avs/api/audio/inc/adsp_mtmx_strtr_api.h#10 $
...
/** @ingroup audio_matrix_stream_router_module_id
    ...
    - #ASM_SESSION_MTMX_STRTR_PARAM_SESSION_CUMU_STATISTICS_V2 @newpage
*/
...
/** @addtogroup audio_matrix_stream_router_module_id
@{ */
...
/** Parameter used by #ASM_SESSION_MTMX_STRTR_MODULE_ID_AVSYNC to specify the
    ...
    Render window start is a value (session time minus timestamp, or ST-TS) below which
    frames are held, and after which frames are immediately rendered.
...
/** Parameter used by #ASM_SESSION_MTMX_STRTR_MODULE_ID_AVSYNC to get the
    ...
    @table{weak__asm__session__mtmx__strtr__param__session__time__v2__t} @newpage
*/
...
/** Parameter used by #ASM_SESSION_MTMX_STRTR_MODULE_ID_AVSYNC to specify the
    ...
    The observation period is defined as the period between any change in
    render or statistics window change.

    Figure region_wrt_ST_minus_TS illustrates the definition of regions
    A, B, and C.

    Unless statistics window start and end are set, statistics cannot be queried
    (the query command will fail).

    @msgpayload{asm_session_mtmx_strtr_session_inst_statistics_v2_t}
    @table{weak__asm__session__mtmx__strtr__session__inst__statistics__v2__t} @newpage
*/
...
{
    uint32_t                  absolute_time_lsw;
    /**< Lower 32 bits of the absolute time in microseconds at which
         instantaneous statistics are calculated. */

    uint32_t                  absolute_time_msw;
    /**< Upper 32 bits of the absolute time in microseconds at which
         instantaneous statistics are calculated.
    ...
    /**< Instantaneous statistics: upper 32 bits of the duration of frames in
         ...
         duration_region_A_msw is a unsigned value in microseconds. This value is
         the duration of frames in region A during the specified observation
         period. */
    ...
    /**< Instantaneous statistics: upper 32 bits of the duration of frames in
         ...
         duration_region_B_msw is a unsigned value in microseconds. This value is
         the duration of frames in region B during the specified observation
         period. */
    ...
    /**< Instantaneous statistics: upper 32 bits of the duration of frames in
         ...
         duration_region_C_msw is a unsigned value in microseconds. This value is
         the duration of frames in region C during the specified observation
         period. */
...
/** Parameter used by #ASM_SESSION_MTMX_STRTR_MODULE_ID_AVSYNC to specify the
    ...
    @table{weak__asm__session__mtmx__strtr__session__cumu__statistics__v2__t}
*/
...
/** @} */ /* end_addtogroup audio_matrix_stream_router_module_id */
