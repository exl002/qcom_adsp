...
/** APR port. This is the least significant 16 bits of the APR handle. */
typedef uint16_t          elite_apr_port_t;

/** APR address. This is the most significant 16 bits of the APR handle. */
typedef uint16_t          elite_apr_addr_t;

/** APR callback function type. @newpage */
...
/** @ingroup eliteapr_func_reg_name
  ...
  @param[in]  pData        Service-defined data pointer to forward on invocation
...
/** @ingroup eliteapr_func_deregister
  ...
  @param[in] handle   Handle of the service to be deregistered.
...
/** @ingroup eliteapr_func_get_opcode
  Gets the APR packet operation code.
...
/** @ingroup eliteapr_func_get_payld_ptr
  Gets the pointer to the APR packet's payload.
...
/** @ingroup eliteapr_func_alloc
  ...
  @param[in]  handle       APR handle of the service making the request.
...
/** @ingroup eliteapr_func_alloc_send_cmd
  ...
  @param[in] opcode         Operation code to be put in the APR packet.
...
/** @ingroup eliteapr_func_alloc_send_ack_result
  Allocates and sends a basic response message. The token and operation code
  are from the original packet. The incoming packet is not freed.

  For more information on this message, refer to @xhyperref{Q3,[Q3]}.
  ...
  @param[in] opcode     Operation code of the APR packet to be acknowledged.
  ...
  @dependencies
  None. @newpage
 */ /* Q3 = Asynchronous Packet Router API Interface Spec (80-N1463-2) */
