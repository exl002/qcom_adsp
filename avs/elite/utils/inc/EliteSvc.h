...
/* Supported Service IDs
  Only the most significant 16 bits are used and can be grown incrementally.
  The least significant 16 bits stay as zeros. This provides an easy way to
  define service-specific custom messages or service-specific parameter IDs.
*/
