...
typedef struct  {
    ...
    uint32_t size_strm_lpa_heap_from_ddr; 
    /**< Size allocated for LPA stream heap from DDR */

    uint32_t size_device_lpa_heap_from_ddr; 
    /**< Size allocated for LPA device heap from DDR */
} lpm_prop_struct_t;
