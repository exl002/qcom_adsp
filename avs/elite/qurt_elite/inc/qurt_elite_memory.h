...
$Header: //source/qcom/qct/images/adsp/avs/rel/2.2/adsp_proc/avs/elite/qurt_elite/inc/qurt_elite_memory.h#14 $
...
/**
  Adds a memory section to a specified heap ID

  @param[in] section_start Pointer to contiguous block of memory used for this section
  @param[in] section_size  Size of the section 
  @param[in] heap_id  	   Heap ID to which the section must be added to 
