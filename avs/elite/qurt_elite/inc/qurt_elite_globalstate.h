...
$Header: //source/qcom/qct/images/adsp/avs/rel/2.2/adsp_proc/avs/elite/qurt_elite/inc/qurt_elite_globalstate.h#15 $
...
{
   mem_wrap_heap_stats_t         heap_stats;
   ...
   volatile uint32_t size_strm_lpa_heap_from_ddr;
   /**< LPA stream heap size */

   volatile uint32_t size_device_lpa_heap_from_ddr;
   /**< LPA device heap size */
   
    uint32_t *ddr_strm_lpa_heap;
    /**< LPA stream heap of 128kB. LPA Stream dynamic buffers will be allocated in this heap */

    uint32_t *ddr_device_lpa_heap;
   /**< LPA device heap of 42kB. LPA device dynamic buffers will be allocated in this heap  @newpagetable */
};
