...
$Header: //source/qcom/qct/images/adsp/avs/rel/2.2/adsp_proc/avs/elite/qurt_elite/inc/qurt_elite_mutex.h#11 $
...
/** Mutex type. */
typedef qurt_rmutex2_t qurt_elite_mutex_t;
...
{
   qurt_rmutex2_init((qurt_rmutex2_t*)pqurt_elite_mutex);
...
{
   qurt_rmutex2_lock((qurt_rmutex2_t*) pqurt_elite_mutex);
}
...
{
    return qurt_rmutex2_try_lock((qurt_rmutex2_t*) pqurt_elite_mutex);
}
...
{
   qurt_rmutex2_unlock((qurt_rmutex2_t*) pqurt_elite_mutex);
}
...
{
    qurt_rmutex2_destroy((qurt_rmutex2_t*) pqurt_elite_mutex);
}
