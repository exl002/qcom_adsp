...
$Header: //source/qcom/qct/images/adsp/avs/rel/2.2/adsp_proc/avs/elite/qurt_elite/inc/qurt_elite_timer.h#10 $
...
typedef enum {
    ...
    QURT_ELITE_TIMER_AVS        /**< Audio/video synchronization timer. */ 
