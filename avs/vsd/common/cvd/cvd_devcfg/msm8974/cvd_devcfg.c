/*
  ...
  $Header: //source/qcom/qct/images/adsp/avs/rel/2.2/adsp_proc/avs/vsd/common/cvd/cvd_devcfg/msm8974/cvd_devcfg.c#6 $
  $Author: coresvc $
*/
...
/**
  ...
  1. Voice use case <-> clock value table as follows: 
     ...
     SOFT VFR         |                   |                     |                      |                      
     -----------------------------------------------------------------------------------
     NONE +           |  65MHz/HW thread  |  163MHz/HW thread   |  163MHz/HW thread    |
     any VFR mode     |                   |                     |                      |
     -----------------------------------------------------------------------------------
     SM_ECNS +        |  65MHz/HW thread  |  163MHz/HW thread   |  163MHz/HW thread    |
     any VFR mode     |                   |                     |                      |
     -----------------------------------------------------------------------------------
     DM_FLUENCE +     |  65MHz/HW thread  |  163MHz/HW thread   |  163MHz/HW thread    |
     any VFR mode     |                   |                     |
     -----------------------------------------------------------------------------------
     SM_FLUENCEV5 +   |  65MHz/HW thread  |  163MHz/HW thread   |  163MHz/HW thread    |
     any VFR mode     |                   |                     |
     -----------------------------------------------------------------------------------
     DM_VPECNS +      |  65MHz/HW thread  |  163MHz/HW thread   |  163MHz/HW thread    |
     any VFR mode     |                   |                     |
     -----------------------------------------------------------------------------------
     DM_FLUENCEV5 +   |  65MHz/HW thread  |  163MHz/HW thread   |  163MHz/HW thread    |
     any VFR mode     |                   |                     |                      |
     -----------------------------------------------------------------------------------
     TM_FLUENCE +     |  65MHz/HW thread  |  163MHz/HW thread   |  163MHz/HW thread    |
     any VFR mode     |                   |                     |                      |
     -----------------------------------------------------------------------------------
