/*
  ...
  $Header: //source/qcom/qct/images/adsp/avs/rel/2.2/adsp_proc/avs/vsd/common/cvd/cvd_devcfg/mdm9x25/cvd_devcfg.c#6 $
  $Author: coresvc $
*/
...
/**
  ...
  1. Voice use case <-> clock value table as follows: 
     ...
     any VFR mode     |                   |                     |                      |
     -----------------------------------------------------------------------------------
     DM_FLUENCEV5 +   |  131MHz/HW thread |  131MHz/HW thread   |  131MHz/HW thread    |
     any VFR mode     |                   |                     |                      |
     -----------------------------------------------------------------------------------
...
static cvd_devcfg_supported_voice_use_case_t cvd_devcfg_clock_level_1_use_cases[ 10 ] = 
  {
...
static cvd_devcfg_clock_level_t cvd_devcfg_clock_levels[ 3 ] = 
  {
    ...
    { 65000000, 10, cvd_devcfg_clock_level_1_use_cases },
