 ...
 */
int adsp_pls_add(uint32 type, uint32 key, int size, int (*ctor)(void* ctx, void* data), void* ctx, void (*dtor)(void*), void** ppo);
 ...
 * @retval, 0 for success
 */
int adsp_pls_lookup(uint32 type, uint32 key, void** ppo);
